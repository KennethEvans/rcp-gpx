...
import net.kenevans.gpxcombined.Oruxmapsextensions.Ext;
        ...
        for(TrkType track : tracks) {
            ...
            if(ext != null) {
                ...
                for(int i = 0; i < objs.size(); i++) {
                    obj = objs.get(i);
                    System.out.println("  Extension " + i + ": " + obj);
                    if(obj instanceof Oruxmapsextensions) {
                        oruxMapsExt = (Oruxmapsextensions)obj;
                        omExt = oruxMapsExt.getExt();
                        System.out.println("  ext=" + omExt);
                        System.out.println("    type=" + omExt.getType());
                        System.out.println("    subtypetype="
                            + omExt.getSubtype());
                        System.out.println("    value=" + omExt.getValue());
                        String bpm = oruxMapsExt.getBpm();
